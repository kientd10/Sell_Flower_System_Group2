                    ...
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-2">
                            <c:choose>
                                <c:when test="${editMode}">
                                    <form action="edit" method="post">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="string" name="phone" class="form-control" value="${user.phone}" />
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="string" name="address" class="form-control" value="${user.address}" />
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="string" name="username" class="form-control" value="${user.username}" />
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <c:otherwise>
                                    <div class="col-md-6">
                                        <label class="labels">Full_Name: </label>
