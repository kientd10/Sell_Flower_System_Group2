    ...
    <body>
        <div class="form-container">
            <div class="form-header">
                ...
                <p class="subtitle">Enter your email to receive a verification code.</p> <!-- Cập nhật thành "verification code" -->
            </div>
            <form action="forgot-password" method="post">
                ...
                <input type="submit" value="SEND VERIFICATION CODE"> <!-- Cập nhật nút -->
            </form>
            <div class="links">
