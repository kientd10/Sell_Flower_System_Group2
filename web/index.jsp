...
<html lang="en">
    <head>
        ...
        <title>Home | E Flower Shop</title>
    ...
    <body>
        ...
        <section id="top-featured-products"><!--/top sell-->
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="title text-center">Sản phẩm nổi bật</h2>

                <div id="featured-carousel" class="carousel slide" data-ride="carousel" data-interval="2000">
                            ...
                            <div class="item ${status.index == 0 ? 'active' : ''}">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <a href="product-detail?id=${product.productId}" class="btn btn-default get">Xem chi tiết</a>
                                    </div>
                                    <div class="col-sm-6">
                                        <img src="${product.imageUrl}" class="img-responsive" alt="${product.name}" style="max-height: 300px; object-fit: cover;" />
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
                    ...
                    <a class="left control-carousel hidden-xs" href="#featured-carousel" data-slide="prev">
                        <i class="fa fa-angle-left"></i>
                    </a>
                    <a class="right control-carousel hidden-xs" href="#featured-carousel" data-slide="next">
