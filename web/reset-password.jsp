                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li style="padding-left: 0">Reset Password</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="login-form">
                        ...
                        <form action="reset-password" method="post">
                            <input type="hidden" name="email" value="${requestScope.email != null ? requestScope.email : param.email}">
                            <input type="hidden" name="code" value="${requestScope.code != null ? requestScope.code : param.code}">
                            ...
                            <span style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                                <a href="login.jsp" style="color: black">Back to Login</a>
                            </span>
