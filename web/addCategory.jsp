...
<head>
    ...
    <title>Thêm danh mục | Flower Shop</title>
        ...
        <div class="main-content">
            <div class="top-navbar">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="input-group" style="width: 300px;">
                        <input type="text" class="form-control" placeholder="Tìm kiếm danh mục..." id="productSearch">
            ...
            <div class="content-area">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2 class="page-title">Thêm danh mục hoa</h2>
                        <p class="text-muted">Thêm một danh mục hoa mới vào hệ thống.</p>
                    </div>
                </div>
