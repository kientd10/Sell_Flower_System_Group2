...
<html lang="en">
    <head>
        ...
        <title>Login | E-Flower Shop</title>
    ...
    <body>
        ...
        <section>
            <form action="forgotPassword" method="post" class="form-container">
                <h2>Forgot Password</h2>

                <div class="form-group">
                    <label for="email">Enter your registered email:</label>
                    <input type="email" name="email" id="email" placeholder="Enter your email" 
                           value="${param.email}" class="form-control" required>
                </div>
        ...
        <style>
            ...
            .form-group {
                margin-bottom: 25px; /* cách dọc rộng hơn */
            }
